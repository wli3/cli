            ...
            string targetFramework = null)
        {
            ...
            try
            {
                ...
                return TransactionalAction.Run<IToolPackage>(
                    action: () => {
                        var stageDirectory = Repository.Root.WithSubDirectories(StagingDirectory, Path.GetRandomFileName());
                        ...
                        return new ToolPackageInstance(packageId, packageVersion, packageDirectory);
                    },
                    rollback: () => {
