...
namespace Microsoft.DotNet.ShellShim.Tests
{
    public class ShellShimRepositoryTests : TestBase
    {
        ...
        private string ExecuteInShell(string shellCommandName, string cleanFolderUnderTempRoot, string arguments = "")
        {
            ...
            processStartInfo.EnvironmentVariables["DOTNET_ROOT"] = Getstage2DotnetPath().Directory.FullName;
        ...
        private static string GetAppHostTemplateFromStage2()
        {
            ...
            var stage2AppHostTemplateDirectory = stage2Dotnet
                .Directory
                .GetDirectory("sdk")
                .GetDirectories()
                .Where(d => !d.Name.Contains("NuGetFallbackFolder"))
                .Single()
