...
namespace Microsoft.DotNet.Tools.Tests.ComponentMocks
{
    internal class ProjectRestorerMock : IProjectRestorer
    {
            ...
            string source = null)
        {
            ...
            if (nugetConfig != null)
            {
                PickFeedByNugetConfig(nugetConfig.Value);
            }
        ...
        public void Restore(FilePath project, DirectoryPath assetJsonOutput)
        {
            ...
            var feedPackage = GetPackage(packageId, packageVersion);
        ...
        {
            var feed = _feeds.SingleOrDefault(
                f => f.Type == MockFeedType.Source && f.Uri == source);
        ...
        {
            var feed = _feeds.SingleOrDefault(
                f => f.Type == MockFeedType.ExplicitNugetConfig && f.Uri == nugetConfig.Value);
